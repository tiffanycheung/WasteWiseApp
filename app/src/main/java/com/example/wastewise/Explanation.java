...
public class Explanation extends AppCompatActivity {
    private TextView descTxt, dailyTxt, dailyPoints, option1, option2, option3, option4, option5, points1, points2, points3, points4, points5;
    private ImageView opt1, opt2, opt3, opt4, opt5, helpBtn, backBtn;
